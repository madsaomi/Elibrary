    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('superadmin', 'Суперадмин'), ('school_admin', 'Школьный админ'), ('teacher', 'Учитель'), ('student', 'Ученик')], default='student', max_length=20, verbose_name='Роль')),
