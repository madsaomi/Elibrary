...
### Мультитенантная CRM-система для школьных библиотек Каракалпакстана
...
**Elibrary** — это комплексная система управления школьными библиотеками, разработанная для.schools Каракалпакстана. Система поддерживает мультитенантность (много школ), ролевую модель доступа и включает элементы геймификации для стимулирования чтения среди учеников.
...
**Сделано с ❤️ для школьных библиотек Каракалпакстана**
