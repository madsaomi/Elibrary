...
| **Центр управления классами** | Единая страница: ученики по классам, младшие 1-4, переводы, продвижение |
...
│   ├── schools/                # Районы, школы, классы, переводы, продвижение
...
│   └── views/                  # Пакет view-функций (__init__.py + модули)
...
| Роль | Возможности |
|------|-------------|
| **Суперадмин** | Управление районами/школами, рейтинг школ, статистика, управление классами |
| **Школьный админ** | Ученики/учителя/классы (единый центр: просмотр, добавление, перевод, продвижение), книги, выдача/возврат, QR-сканер, новости |
| **Учитель** | Каталог учебников своего предмета, выдача/возврат, QR-возврат, лидерборд, классное руководство |
| **Классный руководитель** | Read-only: ученики своего класса, рейтинг класса, выдача учебников |
